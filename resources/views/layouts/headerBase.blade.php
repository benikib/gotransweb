...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2 bg-white my-2 transition"
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mb-1">
                <a class="nav-link py-2 px-3 {{ request()->routeIs('maps.index') ? 'active bg-light text-primary border-start border-primary border-3' : 'text-dark opacity-8' }}"
                    href="{{ route('maps.index') }}">
                    <div class="d-flex align-items-center">
                        <i class="material-symbols-rounded me-3">map</i>
                        <span class="nav-link-text me-2">Maps</span>
                        <span id="nombre" class="badge bg-danger ms-auto"></span>
                    </div>
                </a>
            </li>

...
<body class="bg-light d-flex justify-content-center align-items-center min-vh-100">
    ...
    <button class="btn btn-primary position-absolute top-0 end-0 m-3" onclick="document.body.classList.toggle('bg-dark');document.body.classList.toggle('text-white')">
        🌗 Thème
    </button>

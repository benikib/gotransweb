...
@section('content')
                ...
                <div class="card">
                    <div class="card-header p-3 pb-2">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <button type="button" class="btn btn-sm bg-gradient-dark mb-0 me-2" data-bs-toggle="modal"
                    ...
                    <div class="card-body p-3">
                        <div class="row">
                            @forelse ($typeVehicules as $type)
                                <div class="col-md-4 p-2 mb-md-0 mb-3">
                                    <div
                                        class="card card-body border card-plain border-radius-lg d-flex flex-column h-100 hover-scale transition-all">
                                        <!-- Header with icon and title -->
                                        <div class="d-flex align-items-center mb-2">
                                            <!-- Image icon with modal trigger -->
                                            <div class="icon icon-sm icon-shape bg-gradient-warning shadow text-center rounded-circle me-2 overflow-hidden"
                                                ...
                                                @else
                                                    <i class="material-symbols-rounded text-white opacity-10"
                                                        style="line-height: 40px;">directions_car</i>
                                                @endif
                                            </div>
                                            ...
                                            <button class="btn btn-link btn-sm ms-auto text-dark px-1 mb-0"
                                                data-bs-toggle="modal" data-bs-target="#editTypeVehiculeModal"
                                                title="Modifier"
                                ...
                                {{ $type->tarif->id }})">
                                        ...
                                        <div class="mt-auto pt-2">
                                            <div class="d-flex justify-content-between border-bottom py-1">
                                                ...
                                                <span class="text-xs font-weight-bold">{{ $type->kilo_initiale ?? 1 }}
                                                    {{ $type->tarif->type }}</span>
                                            </div>
                                            <div class="d-flex justify-content-between border-bottom py-1">
                                                <span class="text-xs">Tarif final:</span>
                                                <span class="text-xs font-weight-bold">{{ $type->kilo_final ?? 1 }}
                                                    {{ $type->tarif->type }}</span>
                                            </div>
                                            <div class="d-flex justify-content-between pt-1">
                                                <span class="text-xs">Tarif/ {{ $type->tarif->type }}:</span>
                                                <span class="text-xs font-weight-bold">
                                                    {{ $type->tarif->prix ?? 1 }} {{ $type->tarif->devise }} /
                                                    {{ $type->tarif->kilo_tarif ?? 1 }} {{ $type->tarif->type }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @empty
                                <div class="col-12 text-center py-4">
                                    <i class="material-symbols-rounded text-secondary opacity-10"
                                        style="font-size: 3rem">directions_car_off</i>
                                    <p class="text-sm text-secondary mt-2">Aucun type de véhicule enregistré</p>
                                </div>
                            @endforelse
                        </div>

                        <!-- Single reusable modal for all images -->
                        ...
                        <script>
                            ...
                            function openTypeVehiculeModal(id, nomType, kiloInitial, kiloFinal, tarifId) {
                                // Votre logique existante pour ouvrir le modal d'édition
                                // ...
                            }
                        </script>
                    </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-header p-3 pb-2 border-bottom">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <button type="button" class="btn btn-sm bg-gradient-dark me-2" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal">
                                    <i class="material-symbols-rounded text-sm">add</i> Ajouter
                                </button>
                                <a href="{{ route('users.index', ['m' => 'client']) }}"
                            ...
                            @forelse ($clients as $client)
                                <div class="col-md-4 mb-3">
                                    <div class="card border border-light shadow-xs p-3 h-100 hover-scale transition-all">
                                        <div class="d-flex align-items-center mb-2">
                                            <div class="bg-gradient-warning text-white rounded-circle d-flex justify-content-center align-items-center me-3"
                                            ...
                                            <button class="btn btn-link text-dark px-2 mb-0" data-bs-toggle="modal"
                                                data-bs-target="#editUserModal" data-id="{{ $client->user_id }}"
                                                ...
                                                data-mode="client" title="Modifier" onclick="openEditModal(this)">
                                                <i class="material-symbols-rounded text-lg">edit</i>
                                            </button>
                                        ...
                                        <div class="border-top pt-2 mt-auto">
                                            <p class="text-xs mb-0"><strong>Téléphone :</strong>
                                                {{ $client->user->number_phone }}</p>
                                        </div>
                                    </div>
                                </div>
                            @empty
                ...
                <div class="card shadow-sm">
                    <div class="card-header p-3 pb-2 border-bottom">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('users.create', ['m' => 'livreur']) }}" type="button"
                                    class="btn btn-sm bg-gradient-dark me-2" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal">
                                    <i class="material-symbols-rounded text-sm">add</i> Ajouter
                                </a>
                                <a href="{{ route('users.index', ['m' => 'livreur']) }}"
                                    class="btn btn-sm btn-outline-dark">
                                    <i class="material-symbols-rounded text-sm">list</i> Voir tous
                                </a>
                            </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="card border border-light shadow-xs p-3 h-100 hover-scale transition-all">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <button class="btn btn-link text-dark px-2 mb-0" data-bs-toggle="modal"
                                                data-bs-target="#editUserModal" data-id="{{ $livreur->user_id }}"
                                                ...
                                                data-mode="livreur" title="Modifier" onclick="openEditModal(this)">
                                                <i class="material-symbols-rounded text-lg">edit</i>
                                            </button>
                ...
                <div class="card shadow-sm">
                    <div class="card-header p-3 pb-2 border-bottom">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <button type="button" class="btn btn-sm bg-gradient-dark me-2" data-bs-toggle="modal"
                                    data-bs-target="#ajoutVehiculeModal">
                                    <i class="material-symbols-rounded text-sm">add</i> Ajouter
                                </button>
                    ...
                    <div class="card-body p-3">
                        <div class="row">
                            @forelse ($vehicules as $vehicule)
                                <div class="col-md-4 mb-3">
                                    <div class="card border border-light shadow-xs p-3 h-100 hover-scale transition-all">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-xs text-muted mb-0">Immat: {{ $vehicule->immatriculation }}
                                                </p>
                                            </div>
                                            <button class="btn btn-link text-dark px-2 mb-0" data-bs-toggle="modal"
                                                data-bs-target="#editVehiculeModal" title="Modifier"
                                    ...
                                    <i class="material-symbols-rounded">edit</i>
                                        ...
                                        <div
                                            class="border-top pt-2 mt-auto d-flex justify-content-between align-items-center">
                                            <span class="text-xs">
                                                <strong>État :</strong>
                            ...
                            @empty
                                <div class="col-12 text-center py-4">
                                    <i class="material-symbols-rounded text-secondary opacity-10"
                                        style="font-size: 3rem">car_crash</i>
                    ...
                    <div class="card-header p-3 pb-2 border-bottom">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <a href="{{ route('users.index', ['m' => 'admin']) }}"
                                    class="btn btn-sm btn-outline-dark">
                                    <i class="material-symbols-rounded text-sm">list</i> Voir tous
                                </a>
                            </div>
                    ...
                    <div class="card-body p-3">
                        <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="card border border-light shadow-xs p-3 h-100 hover-scale transition-all">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <button class="btn btn-link text-dark px-2 mb-0" data-bs-toggle="modal"
                                                data-bs-target="#editUserModal" data-id="{{ $admin->user_id }}"
                                                data-name="{{ $admin->user->name }}"
                                                data-email="{{ $admin->user->email }}"
                                                data-phone="{{ $admin->user->number_phone }}"
                                                data-url="{{ route('users.update', $admin->user_id) }}" data-mode="admin"
                                                title="Modifier" onclick="openEditModal(this)">
                                                <i class="material-symbols-rounded text-lg">edit</i>
                                            </button>
                            ...
                            @empty
                                <div class="col-12 text-center py-4">
                                    <i class="material-symbols-rounded text-secondary opacity-10"
                                        style="font-size: 3rem">admin_panel_settings</i>
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-6 d-flex">
            <div class="card shadow-sm flex-fill">
                <div class="card-header p-3 pb-2 border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="mb-0 text-dark">Tarifs</h6>
                        <div>
                            <button class="btn btn-sm bg-gradient-dark me-2" data-bs-toggle="modal"
                                data-bs-target="#addKiloModal">
                                <i class="material-symbols-rounded text-sm">add</i> Ajouter
                            </button>
                ...
                <div class="card-body p-3 pt-0">
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">Nom
                                    </th>
                            ...
                            <tbody>
                                @forelse ($tarifs as $tarif)
                                    <tr class="hover-scale transition-all bg-white border-bottom">
                                        ...
                                        <td class="ps-3">
                                            <h6 class="mb-0 text-sm">{{ $tarif->valeur }} {{ $tarif->type }}</h6>
                                        </td>
                                        <td class="ps-3">
                                            <h6 class="mb-0 text-sm">{{ number_format($tarif->prix, 2, ',', ' ') }}
                                                {{ $tarif->devise }}</h6>
                                        </td>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @forelse ($livreur_vehicules as $lv)
                                    <tr class="hover-scale transition-all bg-white border-bottom">
                                        <td class="ps-3">
                                            <h6 class="mb-0 text-sm font-weight-bold">
                                                {{ $lv->livreur->user->name ?? 'Inconnu' }}</h6>
                                        </td>
                                        <td class="ps-3">
                                            <h6 class="mb-0 text-sm">{{ $lv->vehicule->type_vehicule->nom_type ?? 'A/N' }}
                                            </h6>
                                        </td>
                                        <td class="ps-3">
                                        ...
                                        <td class="text-end">
                                            <button class="btn btn-link text-dark px-2 mb-0" title="Modifier"
                                                ...
                                                data-bs-target="#editVehiculeLivreurModal{{ $lv->id }}">
                                                <i class="material-symbols-rounded text-lg">edit</i>
                                            </button>
                                    ...
                                    <div class="modal fade" id="editVehiculeLivreurModal{{ $lv->id }}"
                                        tabindex="-1" aria-labelledby="editVehiculeLivreurModalLabel{{ $lv->id }}"
                                        aria-hidden="true">
                                            ...
                                            <div class="modal-content shadow border-0 rounded-4">
                                                ...
                                                <div class="modal-header text-dark rounded-top-4">
                                                    <h5 class="modal-title"
                                                        id="editVehiculeLivreurModalLabel{{ $lv->id }}">Modifier
                                                        l'affectation véhicule / livreur
                                                    </h5>
                                                ...
                                                <div class="modal-body bg-white">
                                                    <form action="{{ route('livreurVehicule.update', $lv->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        ...
                                                        @isset($lv->vehicule)
                                                            <div class="mb-3">
                                                                <label for="vehiculeSelect"
                                                                    class="form-label">Véhicule</label>
                                                                <select name="vehicule_id" id="vehiculeSelect"
                                                        ...
                                                        @isset($lv->livreur)
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="livreur_id" id="livreurSelect"
                                                                    class="form-select" required>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-center py-4">
                                            <i class="material-symbols-rounded text-secondary"
                                                style="font-size: 3rem">group_off</i>
    ...
    <div class="modal fade" id="addKiloModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="{{ route('tarifs.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border border-secondary" name="nom"
                                placeholder="Ex: Standard" required>
                        </div>

                        <div class="mb-3">
                            <label for="typeInput" class="form-label">Type de tarif</label>
                            <input type="text" class="form-control border border-secondary" id="typeInput"
                                name="type" placeholder="Ex: Tarif Kilo, course" required maxlength="255"
                                oninput="updateTypeLabel(this.value)">
                        </div>

                        <div class="mb-3">
                            <label id="typeLabel" class="form-label">Unité du tarif</label>
                            <input type="number" class="form-control border border-secondary" name="valeur"
                                placeholder="Ex: 1, 2, 3" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Prix par unité</label>
                            <div class="input-group" style="max-width: 400px;">
                                <input type="number" step="0.01" class="form-control mx-5" name="prix" required
                                    placeholder="0.00">

                                <span class="input-group-text bg-transparent border-0 mx-5">/</span>

                                <select class="form-select mx-5" name="devise" style="width: 120px;">
                        ...
                        <script>
                            function updateTypeLabel(value) {
                                ...
                                const unitText = value.trim() !== '' ? value : 'tarif';
                                typeLabel.textContent = `Unité du ${unitText}`;
                            }

                            // Initialiser le label au chargement de la page
                            document.addEventListener('DOMContentLoaded', function() {
                                const typeInput = document.getElementById('typeInput');
                                if (typeInput) {
                                    updateTypeLabel(typeInput.value);
                                }
                            });
                        </script>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content shadow">
      ...
      <div class="modal-body">
        <form id="editTarifForm" method="POST">
            ...
            <div class="mb-3">
                <label for="edit_prix" class="form-label">Prix du Tarif</label>
    ...
    <div class="modal fade" id="typeVehiculeModal" tabindex="-1" aria-labelledby="typeVehiculeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="typeVehiculeForm" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tarif_id" id="modal_tarif_id" class="form-select border border-secondary"
                                required>
                                <option value="">Sélectionnez un tarif</option>
                                @foreach ($tarifs as $tarif)
                                    <option value="{{ $tarif->id }}"
                                        data-display="{{ $tarif->type }}  / ${{ $tarif->prix }}">
    ...
    <script>
        function openVehiculeLivreurModal(livreurVehiculeId, vehiculeId, livreurId) {
            ...
            console.log(livreurVehiculeId)
            form.action = `/affectation/${livreurVehiculeId}`;

            // si ta route est bien RESTful

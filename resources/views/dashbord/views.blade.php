                        ...
                        <div class="row">
                            @foreach ($typeVehicules as $type)
                                <div class="col-md-4 p-2 mb-md-0 mb-3">
                                    <div class="card card-body border card-plain border-radius-lg d-flex flex-column h-100 hover-shadow-lg transition-all">
                                        ...
                                        <div class="mt-auto">
                                            ...
                                            <p class="mb-1">Tarif final : <strong>{{ $type->kilo_final * $type->tarif->prix_tarif }} $</strong></p>
                ...
                <div class="card h-100">
                    <div class="card-header pb-0 p-3">
                        <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <button data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-outline-primary btn-sm mb-0 me-2">
                    ...
                    <div class="card-body p-3">
                        <ul class="list-group">
                            @foreach ($livreurs as $livreur)
                                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg hover-shadow-sm transition-all">
                                    ...
                                    <div class="d-flex align-items-center text-sm">
                                        <a href="{{ route('users.edit', $livreur->id) }}" class="btn btn-link text-dark text-sm mb-0 px-0 ms-4">
                    ...
                    <div class="card-body pt-4 p-3">
                        <ul class="list-group">
                            @foreach ($vehicules as $vehicule)
                                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg hover-shadow-lg transition-all">
                                    <div class="d-flex flex-column">
                                        <h6 class="mb-3 text-sm">{{ $vehicule->proprietaire }}</h6>
                                        <div class="d-flex flex-column gap-1">
                                            <span class="text-xs">Couleur : <span class="text-dark font-weight-bold ms-sm-2">{{ $vehicule->couleur }}</span></span>
                                            <span class="text-xs">Immatriculation : <span class="text-dark ms-sm-2 font-weight-bold">{{ $vehicule->immatriculation }}</span></span>
                        ...
                        <ul class="list-group">
                            @foreach ($admins as $admin)
                                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg hover-shadow-sm transition-all">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-sm me-3">
                                            <span class="avatar-initial rounded-circle bg-gradient-warning">
